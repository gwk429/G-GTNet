...
if __name__ == '__main__':
    ...
    parser.add_argument('--chosen_snapshot', default='PointDSC_KITTI_06291319', type=str, help='snapshot dir')
    ...
    config_path = f'F:/gwk/PointDSC-master/snapshot/PointDSC_KITTI_06291319/config.json'
    ...
    miss = model.load_state_dict(torch.load(f'F:/gwk/PointDSC-master/snapshot/PointDSC_KITTI_06291319/models/model_best.pkl'), strict=False)
    print(miss)
    model.eval()

    # evaluate on the test set
    stats = eval_KITTI(model.to(device), config, args.use_icp)
